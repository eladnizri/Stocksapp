  ...
  if (n === 1) {
    return {
      ...
      body:
        ...
        '<div class="gstep"><b>2.</b> מלא שם, מייל וסיסמה, ולחץ על כפתור ' +
          '<b>Sign Up</b> הירוק. <b>אין צורך לאמת את המייל</b> — אתה עובר ' +
          'ישר לדשבורד שלך.</div>' +
        '<div class="gstep"><b>3.</b> בדשבורד, תחת הכותרת <b>API Key</b>, ' +
          'המפתח מוסתר בנקודות. יש לצידו שני כפתורים קטנים — <b>עין</b> ' +
          '(מציגה אותו) ו־<b>העתקה</b> (מעתיקה אותו ישירות, בלי להציג).</div>' +
